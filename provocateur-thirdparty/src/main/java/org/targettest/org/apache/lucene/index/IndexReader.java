...
import org.targettest.org.apache.lucene.store.*;
...
public abstract class IndexReader implements Cloneable,Closeable {
   ...
   * @see org.targettest.org.apache.lucene.document.Field.TermVector
   */
  ...
  /**
   * Get the {@link org.targettest.org.apache.lucene.document.Document} at the <code>n</code>
   * <sup>th</sup> position. The {@link FieldSelector} may be used to determine
   * what {@link org.targettest.org.apache.lucene.document.Field}s to load and how they should
   * be loaded. <b>NOTE:</b> If this Reader (more specifically, the underlying
   * <code>FieldsReader</code>) is closed before the lazy
   * {@link org.targettest.org.apache.lucene.document.Field} is loaded an exception may be
   * thrown. If you want the value of a lazy
   * {@link org.targettest.org.apache.lucene.document.Field} to be available after closing you
   ...
   *         {@link org.targettest.org.apache.lucene.document.Document} at the nth position
   * @throws CorruptIndexException if the index is corrupt
   * @throws IOException if there is a low-level IO error
   ...
   * org.targettest.org.apache.lucene.document.Fieldable#setBoost(float) boost} and its {@link Similarity#lengthNorm(String,

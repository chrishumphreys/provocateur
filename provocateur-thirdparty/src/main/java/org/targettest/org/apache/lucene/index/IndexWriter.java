...
import org.targettest.org.apache.lucene.analysis.Analyzer;
import org.targettest.org.apache.lucene.document.Document;
import org.targettest.org.apache.lucene.index.DocumentsWriter.IndexingChain;
import org.targettest.org.apache.lucene.search.Query;
import org.targettest.org.apache.lucene.search.Similarity;
import org.targettest.org.apache.lucene.store.AlreadyClosedException;
import org.targettest.org.apache.lucene.store.BufferedIndexInput;
import org.targettest.org.apache.lucene.store.Directory;
import org.targettest.org.apache.lucene.store.Lock;
import org.targettest.org.apache.lucene.store.LockObtainFailedException;
import org.targettest.org.apache.lucene.util.Constants;
import org.targettest.org.apache.lucene.util.ThreadInterruptedException;
...
public class IndexWriter implements Closeable {
   ...
   *  index
   * @param deletionPolicy see <a href="#deletionPolicy">above</a>
   * @param mfl {@link org.targettest.org.apache.lucene.index.IndexWriter.MaxFieldLength}, whether or not to limit field lengths.  Value is in number of terms/tokens
   * @throws CorruptIndexException if the index is corrupt
   * @throws LockObtainFailedException if another writer
   *  has this index open (<code>write.lock</code> could not
   *  be obtained)
   ...
   *  index
   * @param deletionPolicy see <a href="#deletionPolicy">above</a>
   * @param mfl whether or not to limit field lengths, value is in number of terms/tokens.  See {@link org.targettest.org.apache.lucene.index.IndexWriter.MaxFieldLength}.

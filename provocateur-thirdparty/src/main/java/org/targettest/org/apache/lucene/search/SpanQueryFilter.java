...
import org.targettest.org.apache.lucene.util.OpenBitSet;
 ...
 * <p/>
 * This filter does not cache.  See the {@link org.targettest.org.apache.lucene.search.CachingSpanFilter} for a wrapper that
 * caches.
 *
 *
 * @version $Id:$
...
public class SpanQueryFilter extends SpanFilter {
   ...
   * <code>query</code>.
   * @param query The {@link org.targettest.org.apache.lucene.search.spans.SpanQuery} to use as the basis for the Filter.
   */
